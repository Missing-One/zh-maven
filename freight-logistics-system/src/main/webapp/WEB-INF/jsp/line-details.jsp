...
<div class="container biao">
	<div style="margin-left:0; margin-right:0;">
    	 <ul class="row xiangqing" style="background:#f5f5f5">
             <li class="tit_hover col-lg-2 col-md-2 col-sm-1" id="huo1" onclick="setTab2(&#39;huo&#39;,1,6)">驾照分数</li>
             <li class="col-lg-2 col-md-2 col-sm-2" id="huo2" onclick="setTab2(&#39;huo&#39;,2,6)">我的分数</li>
             <li class="col-lg-2 col-md-2 col-sm-2" id="huo3" onclick="setTab2(&#39;huo&#39;,3,6)">车辆交易</li>
             <li class="col-lg-2 col-md-2 col-sm-2" id="huo4" onclick="setTab2(&#39;huo&#39;,4,6)">我的交易</li>
             <li class="col-lg-2 col-md-2 col-sm-2" id="huo5" onclick="setTab2(&#39;huo&#39;,5,6)">招聘信息</li>
             <li class="col-lg-2 col-md-2 col-sm-2" id="huo6" onclick="setTab2(&#39;huo&#39;,6,6)">我的招聘</li>
         </ul>
         <!--驾照分数-->
        	...
        	<div class="bill_chaxun">
            	<form action="" method="post" class="form-horizontal bd">
                    <div class="form-group row" style="margin-bottom:0;">
                        <label class="col-md-1 control-label">所在城市</label>
                        <div class="list_div col-md-2 area-wraper">
                        ...
                        <label class="col-md-1 control-label">驾照类型</label>
         ...
         <div class="bill_left_text" id="list_huo3" style="display:none">
        	<div class="bill_chaxun">
            	<form action="" method="post" class="form-horizontal bd">
                    <div class="form-group row" style="margin-bottom:0;">
                    	<label class="col-md-1 control-label">我要</label>
            ...
            <table class="table table-bordered tupian" style="margin-bottom:0;">
            	<thead>
                	<tr style="background-color:#ebebeb">
                    	<td>身份</td>
                        <td>车辆类型</td>
            ...
            <table class="table table-bordered" style="margin-bottom:0;">
                ...
                <tbody>
                	<tr>
                        <td>李一平</td>
                        <td>C1</td>
                        <td>车辆描述车辆描述车辆描述车辆描述车辆描述车辆描述车辆描述</td>
                        <td>浙江省-湖州市-全市</td>
                    ...
                    <tr>
                        <td>李一平</td>
                        <td>C1</td>
                        <td>车辆描述车辆描述车辆描述车辆描述车辆描述车辆描述车辆描述车辆描辆描述车辆描描述</td>
                        <td>浙江省-湖州市-全市</td>
                        <td>2016-01-11 00:00:00</td>
                        <td>3.2米</td>
                        <td>
         ...
         <!--招聘信息-->
         <div class="bill_left_text" id="list_huo5" style="display:none;">
         	<form action="" method="post" class="form-horizontal bd">
                <div class="form-group row" style="margin-bottom:0;">
            ...
            <div class="list_more" id="getmore5">更多»</div>
         </div>
         <!--我的招聘-->
         <div class="bill_left_text" id="list_huo6" style="display:none;">
            <div class="hy_right_top">
                <p>我的招聘</p>
            </div>       
            <table class="table table-bordered" style="margin-bottom:0;">
            ...
            <div class="list_more" id="getmore6">更多»</div>
         </div>
    </div>
</div>
