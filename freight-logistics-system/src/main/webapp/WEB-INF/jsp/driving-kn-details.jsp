...
<title>新广货运联盟-驾驶常识-常用驾驶常识</title>
...
<div class="container">
	<ol class="breadcrumb">
        ...
        <li><a href="driving-knowledge.html">驾驶常识</a></li>
        <li><a href="#">常用驾驶常识</a></li>
        <li class="active">正文</li>
    </ol>
    <div class="row neirong">
    	<div class="col-sm-8">
            <div>
                <h2 class="text-center">常用驾驶常识大全</h2>
                <p>1、上车先看车上车前绕车转一圈，看车的外况、轮胎、车底下有没有漏油漏水。一个星期还得揭开盖子检查一次机油、冷却水、刹车油。</p>
                <p>2、点火步骤拉紧手刹（防备滑动），离合器踩到底，空档，不踩油门（加速踏板），转动钥匙到Ⅱ档后停6秒钟，让汽车电子系统上电自检，启动润滑系统，然后继续转动钥匙到Ⅲ档点火。点火成功后，挂一档、松手刹、慢抬离合、加油、出发。</p>
                <p>3、开车先热车电喷车几乎不用热车。这里热车是指启动润滑系统。停车超过3小时，发动机点着火后，怠速10秒以上，转速表下降到1000左右，再发车。北方严寒天气适当延长怠速热车时间。</p>
                <p>4、上车先看车上车前绕车转一圈，看车的外况、轮胎、车底下有没有漏油漏水。一个星期还得揭开盖子检查一次机油、冷却水、刹车油。</p>
                <p>5、上车先看车上车前绕车转一圈，看车的外况、轮胎、车底下有没有漏油漏水。一个星期还得揭开盖子检查一次机油、冷却水、刹车油。</p>
                <p>6、上车先看车上车前绕车转一圈，看车的外况、轮胎、车底下有没有漏油漏水。一个星期还得揭开盖子检查一次机油、冷却水、刹车油。</p>
                <p>2、点火步骤拉紧手刹（防备滑动），离合器踩到底，空档，不踩油门（加速踏板），转动钥匙到Ⅱ档后停6秒钟，让汽车电子系统上电自检，启动润滑系统，然后继续转动钥匙到Ⅲ档点火。点火成功后，挂一档、松手刹、慢抬离合、加油、出发。</p>
                <p>2、点火步骤拉紧手刹（防备滑动），离合器踩到底，空档，不踩油门（加速踏板），转动钥匙到Ⅱ档后停6秒钟，让汽车电子系统上电自检，启动润滑系统，然后继续转动钥匙到Ⅲ档点火。点火成功后，挂一档、松手刹、慢抬离合、加油、出发。</p>
                <p>2、点火步骤拉紧手刹（防备滑动），离合器踩到底，空档，不踩油门（加速踏板），转动钥匙到Ⅱ档后停6秒钟，让汽车电子系统上电自检，启动润滑系统，然后继续转动钥匙到Ⅲ档点火。点火成功后，挂一档、松手刹、慢抬离合、加油、出发。</p>
                <p>2、点火步骤拉紧手刹（防备滑动），离合器踩到底，空档，不踩油门（加速踏板），转动钥匙到Ⅱ档后停6秒钟，让汽车电子系统上电自检，启动润滑系统，然后继续转动钥匙到Ⅲ档点火。点火成功后，挂一档、松手刹、慢抬离合、加油、出发。</p>
            ...
            <div>
            	<p><span>上一篇： </span><a href="">用赛车来做示范 论刹车失灵的正确自救方法</a></p>
                <p><span>下一篇： </span><a href="">用赛车来做示范 论刹车失灵的正确自救方法</a></p>
            </div>
        </div>
        <div class="col-sm-3 col-sm-offset-1">
        	<p class="pic">广告图片</p>
            <hr>
            <a href="" target="_blank"><img src="${pageContext.request.contextPath }/images/93ce5c4da31cd173.jpg" class="text-center img-responsive" style="width:100%; height:100%"></a><hr>
            <a href="" target="_blank"><img src="${pageContext.request.contextPath }/images/93ce5c4da31cd173.jpg" class="text-center img-responsive" style="width:100%; height:100%"></a><hr>
            <a href="" target="_blank"><img src="${pageContext.request.contextPath }/images/93ce5c4da31cd173.jpg" class="text-center img-responsive" style="width:100%; height:100%"></a><hr>
        </div>
    </div>
